...
const MENU_IMAGES = [
  ...
  {
    id: 1,
    imageDesktop: "degu-en-cp.jpg",
    imageMobile: "mobiledegu-en-cp.jpg",
    width: 2251,
    height: 4001,
  },
  {
    id: 2,
    imageDesktop: "vegano-en-cp.jpg",
    imageMobile: "mobilevegano-en-cp.jpg",
    width: 2251,
    height: 4001,
  },
  {
    id: 3,
    imageDesktop: "fuertes-en-cp.jpg",
    imageMobile: "fuertes-en-cp.jpg",
    width: 1900,
    height: 1385,
  },
  {
    id: 4,
    imageDesktop: "entra-en-cp.jpg",
    imageMobile: "mobileentra-en-cp.jpg",
    width: 2251,
    height: 4000,
  },
  {
    id: 5,
    imageDesktop: "verde-en-cp.jpg",
    imageMobile: "mobileverde-en-cp.jpg",
    width: 2251,
    height: 3500,
  },
  {
    id: 6,
    imageDesktop: "postres-cp.jpg",
    imageMobile: "mobilepostres-cp.jpg",
    width: 2251,
    height: 3500,
  },
];
...
export default function Home() {
  return (
    <Fragment>
      <Head>
        <title>Sud777</title>
        <meta name="description" content="SUUD" />
      </Head>
      <main>
        ...
        <div className={styles.chef} id="chef">
          ...
          <div className={styles.texto}>
            ...
            <Paragraph>
              El comensal puede explorar sus dos visiones en torno a la cocina
              en los restaurantes de los cuales es chef co-propietario. El
              primero de años es SUD 777 y es su visión del fine dining, la cual
              lo ha colocado en la posición 11 del conteo Latin America’s 50
              Best Restaurants. Es también chef co-propietario de Comedor
              Jacinta, un comedor mexicano con una propuesta casual dining mucho
              más informal con platillos de su infancia y su interpretación de
              cómo ve la cocina mexicana hoy en día.
            </Paragraph>
            <Paragraph>
              El chef es miembro de la ACADEMIE CULINAIRE DE FRANCE y del
